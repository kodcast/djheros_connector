...
class Plugin(BasePlugin):
    def __init__(self, *args, **kwargs):
        ...
        self.log(_("🔄 Loading djheros_connector plugin..."))
    ...
    def loaded_notification(self):
        ...
        self.log(_("🔔 Plugin djheros_connector loaded."))
    ...
    def show_window(self):
        ...
        self.window = Gtk.Window(title=_("djheros_connector"))
        ...
        url_label = Gtk.Label(label=_("enter the adress (ex: https://yourdjherosplace.com/) :"))
